...
Пока черновик не сохранён, он существует только в памяти Telegram-сессии (`context.user_data`) и теряется при закрытии диалога или перезапуске бота — это ожидаемое ограничение. Редактирование содержимого черновика перед сохранением и объединение с уже непустыми разделами урока не реализованы и запланированы отдельным следующим этапом (Teacher Draft Editor).
