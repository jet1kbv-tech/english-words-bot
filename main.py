...
from app.handlers.teacher import teacher_progress_callback, teacher_student_callback, teacher_view_as_callback
...
def build_application() -> Application:
    ...
    application.add_handler(CallbackQueryHandler(teacher_student_callback, pattern=r"^teacher_student:[a-z0-9_]+$"))
    application.add_handler(CallbackQueryHandler(teacher_progress_callback, pattern=r"^teacher_progress:[a-z0-9_]+$"))
    application.add_handler(CallbackQueryHandler(teacher_view_as_callback, pattern=r"^teacher_view_as:[a-z0-9_]+$"))
